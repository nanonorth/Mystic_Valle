                ...
                for (int x = 0; x < mapWidth; x++) {
                    ...
                    if (isTopLayer) {
                        ...
                        if (type.equals("roof")) {
                            ...
                            buf[y][x].worldBottomY += tileHeight * 2.3;       // ✅ ศีรษะไม้/สโนว์แมน
                        }
                        // trunk/body ไม่เพิ่ม
                    }
                }
    ...
    public void drawDebugWarp(Graphics2D g, int camX, int camY, double zoom, int warpX, int warpY) {
        ...
        RadialGradientPaint paint =
            new RadialGradientPaint(
                ...
                new Color[]{
                    new Color(210, 240, 255, 240), // กลางสว่าง
                    new Color(10, 90, 180, 220),  // ฟ้าเข้ม
                    new Color(0, 20, 60, 240)     // น้ำเงินดำ ความลึก
                }
            );
        g.setPaint(paint);
