...
/**
 * Base class for enemies, movement + collision like Player.
 */
public abstract class Enemy extends Entity {
    ...
    protected int invincibleTime = 30; // ~0.25s at 120 FPS
    ...
    // ✅ Collision hitbox (แก้ตามขนาดของ Boss ได้)
    ...
    /** Movement with collision like Player */
    ...
    /** Called when taking damage from player/projectiles */
