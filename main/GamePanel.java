...
public class GamePanel extends JPanel implements Runnable {
	...
	public int gameState = STATE_PAUSE;
	...
	public void doWarp(int targetMapID) {
		...
		if (currentMapId == 1) {
			...
			if (currentMapId == 1) {
				...
				if (boss != null) {
					boss.scaleWithPlayer(player.getLevel());
				}

				if (bossDefeated) {
					boss.resetBoss();
					bossDefeated = false;
					System.out.println("Boss respawned when re-entering dungeon");
				}
			}
